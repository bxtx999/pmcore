...
clang++ -g0 -O3 -DNDEBUG=1 -march=native -std=c++17 bench/interference.cpp -I/Arachne/include -ICoreArbiter/include  -IPerfUtils/include -I${PMDK}/src/include/ ${PMDK}/src/nondebug/libpmem.a ${PMDK}/src/nondebug/libpmemlog.a -LArachne/lib -lArachne -LCoreArbiter/lib -lCoreArbiter -LPerfUtils/lib/ -lPerfUtils  -lpcrecpp -lpthread -lndctl -ldaxctl || exit -1
